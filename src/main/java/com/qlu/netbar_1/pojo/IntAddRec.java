...
public class IntAddRec {
    ...
    public IntAddRec( int addRecordId, Date addTime, int interimId, int addMoney, int adminId) {
    ...
    public IntAddRec( Date addTime, int interimId, int addMoney, int adminId) {
        this.addTime = addTime;
        this.interimId = interimId;
        this.addMoney = addMoney;
        this.adminId = adminId;
