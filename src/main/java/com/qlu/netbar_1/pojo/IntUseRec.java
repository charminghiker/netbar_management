...
public class IntUseRec {
    ...
    public IntUseRec(int useRecordId, int machineId, Date startTime, Date endTime, int interimId, int addMoney, int consumption, int remains, int adminId) {
